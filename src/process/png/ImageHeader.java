...
public class ImageHeader {
    ...
    public static boolean headerChecker(File file) {
    ...
    public static boolean headerRepair(File file) {
...
//        }
    ...
    private static void saveImage(final byte[] bytes) throws IOException {
